...
SECRET_KEY = 'django-insecure-2ck-q^(7kvvz3azjfo@idbay9r#5yq^_%aezhzk3u3dmf=3#ue'
...
INSTALLED_APPS = [
    'jazzmin',  # Jazzmin must be before
    ...
    'rest_framework_gis',  # GIS support for Django REST Framework
